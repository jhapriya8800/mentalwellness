  ...
  return (
    ...
    <section id='home' className='bg-heroBg text-white flex items-center pt-28 md:h-screen'>
      ...
      overflow-y-hidden gap-12 h-full'>
        ...
        <p className='text-lg mb-12 md:pr-8'>We lower our stress levels,we get to know
        our pain,we connect better,we improve our
        focus, and we're kinder to ourselves.Let us 
        walk you through the basics in our new mindful guid on how to
        meditate.
        </p>
        <button className='bg-primary text-white py-2.5 px-5 font-medium rounded-md
        hover:bg-primary/90 ' >
        ...
        <div className='md:w-1/2 h-full'>
          <img src={HeroImg} alt="hero_image" className='w-full object-cover'/>
        </div>
      </div>
    </section>
